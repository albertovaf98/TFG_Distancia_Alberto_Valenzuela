  ...
  <body>      
    <div id="contenedor">        
        <div id="log">
            ...
            <div id="login">
                    <form method="post" id="loginform" action="rsusu.php">
                        ...
                        <button  type="submit" title="Ingresar" name="Ingresar" href="administrador.html">Resetear</button>
                    </form>
                    <br>
                    ...
                    <?php 
                        ...
                        if (isset($_POST['Ingresar'])) {
                            ...
                            echo "<br>";
                            echo '<div class="bien">Reseteo de usuario correcto</div>';
                            }else if($log ==0){
                                echo "<br>";
